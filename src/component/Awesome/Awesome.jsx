            ...
            <div className="grid grid-cols-3 mx-auto w-11/12">
                    ...
                    <div className="grid grid-rows-4">
                        ...
                        <div className="row-span-1 call  shadow-lg  m-auto h-full">
                            <div className="grid grid-cols-3 py-2">
                                <div className=" my-auto p-4 font-extrabold  col-span-2 ">
                                    We are just a call away
                                </div>
                                <div className="col-span-1 border   shadow-lg phone ">
                                    <FaPhone size={40} className='text-green-500 phone' /> 
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-span-3 md:col-span-1 mx-auto w-full">
                    <div className="grid grid-rows-3 overflow-hidden">
                        <div className="row-span-1 booking-icon w-9/12 mx-auto border-2 shadow-lg mb-3 py-4 px-3 ">
                        ...
                        <div className="mt-3 mb-3 row-span-2 machine">
                ...
                <div className="col-span-3 hidden md:block md:col-span-1 mb-3 shadow-lg">
                    <div className="grid grid-rows-4">
                        <div className="row-span-1 customer h-20 bg-blue-500 shadow-lg mb-4">
                            <div className="grid grid-cols-3 ">
                                ...
                                <div className="col-span-1 p-4 h-full flex items-center">
                                    <FaGlobe size={40} className='text-white globe font-bold' />
                                </div>
                            </div>
                        </div>
