...
const Card = ({card}) => {
  ...
  return (
  <div className=" feature-card col-span-1 mb-5 w-11/12 shadow-md bg-white rounded-md  md:shadow-md m-auto hover:shadow-lg ">
      <div  id={card.id == 1 ? 'style-1' : card.id == 2 ? 'style-2' : card.id == 3 ?  "style-3" : ''}
    className=' rounded-md  text-center    w-full m-auto '>
